...
int main(int argc, char* argv[])
{
    ...
    Rectangle innerRect, outterRect;
    auto nets       = parseNetsInfo(file, resolution, innerRect, outterRect);
    auto boundaries = buildCommonBoundaries(nets);
    std::cout<<resolution<<std::endl;
    std::cout<<innerRect.rect_x<<" "<<innerRect.rect_y<<" "<<innerRect.rect_w<<" "<<innerRect.rect_h<<std::endl;
    std::cout<<outterRect.rect_x<<" "<<outterRect.rect_y<<" "<<outterRect.rect_w<<" "<<outterRect.rect_h<<std::endl;
